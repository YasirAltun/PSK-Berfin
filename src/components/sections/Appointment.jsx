    ...
    <section id="randevu" ref={ref} className="section-padding relative overflow-hidden">
      ...
      <motion.div style={{ y: contentY, opacity: contentOpacity }} className="container-md relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <p className="section-label mb-3">İlk Adım</p>
            <h2 className="heading-lg text-mint-dark mb-6">Randevu Al</h2>
          </motion.div>
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white font-sans font-medium text-base rounded-2xl shadow-lg hover:bg-[#1ebe5d] transition-all hover:-translate-y-1 active:translate-y-0"
            >
              ...
              {siteConfig.appointment.ctaText}
            </a>
          </motion.div>
        </div>
      </motion.div>
